...
class projectDetail extends Component {
  ...
  getProjectData() {
    axios
      .get(`http://52.77.234.30/projects/${this.props.params.projectid}/detail?start=2017-06-01&end=2017-06-30`)
      .then(response => {
        this.setState({
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-8 boxleft">
            {!this.state.projects
              ? ''
              : <TableData users={this.state.projects} projectid={this.props.params.projectid} />
